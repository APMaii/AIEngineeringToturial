...
GUI --> Graphical User Interface [Rabete karbari geraphici]  -->Yani shekl dare mitoni bebini
You click buttons, folders, menus (Explorer, Finder).

CLI --> Command Line Interface [Rabete karbari dastoori ]  --> Yani code bayad bzni (dastoor)
...
'''
Pas Yadet bashe, harmoghe shoma Terminal, ya har Shelli ro baz mikoni mesle
bash --> Bash yek mohiti barat ijad mikone k to toosh COMMAND (dastoor)et ro bezani 
...
baziashonam mitonim download konim , koli CLI tool dar jahan vojod dare
baraye hezxaran karborde motefavet
...
Environemnt --> echo , export , env  , alias [manage environment variables]
...
ama agar bekhaym taghir bedim niaz darim b yek abzari be name text editing,
ma koli abzar haye mokhtalef darim hata abzar haye kh kh pichide ama dota az
maroof tairn haro inja migm k 

----- vim -------
Vim (Vi Improved) yek text editore ghavi hast rooye Unix/Linux system.
and khob ma normal mode ta koli mdoe haye mokhtalef. 
...
lsof -i --> in neshoon mide hame process haye rooye networke laptabetoon
...
----git---
in git_tutorial.py file shoma mitonid git ro bebinid
