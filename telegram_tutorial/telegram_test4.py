'''
ino omadim az telegram_test3.py copy paste kardim

Inline keyword mikhaymbesazim

(Inlinekeyboardbuttons)
ye commande jadid bename menu --> zad rosh biare


Gozine tarahi karidm
vaghty yeki zad menu --> dota gozine ovord
'''
