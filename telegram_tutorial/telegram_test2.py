'''
ino omadim az telegram_test1.py copy paste kardim

mikjaym yek command jadid beszim bname /help


aval mirim tooye main() migim k ag kasi help zad b felan tabe vaslesh kon
badesh oon tabe ro minevisim


****
baraye tamrin --> dota commande dg ezafe konan 
